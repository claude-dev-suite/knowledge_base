# Infrastructure - Sparrow - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/infrastructure/sparrow`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/infrastructure/sparrow/SKILL.md
