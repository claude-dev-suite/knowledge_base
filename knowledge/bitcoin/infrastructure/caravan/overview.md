# Infrastructure - Caravan - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/infrastructure/caravan`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/infrastructure/caravan/SKILL.md

## What this covers

Caravan: open-source web-based multisig coordinator (no install). Read-only by default; HW wallet support via HWI bridge.
