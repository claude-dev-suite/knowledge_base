# Infrastructure - Electrum Wallet - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/infrastructure/electrum-wallet`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/infrastructure/electrum-wallet/SKILL.md

## What this covers

Electrum Wallet: classic Python desktop wallet. Lightweight, runs on most platforms, plugin ecosystem, hardware wallet support.
