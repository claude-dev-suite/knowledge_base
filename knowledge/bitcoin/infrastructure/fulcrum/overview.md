# Infrastructure - Fulcrum - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/infrastructure/fulcrum`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/infrastructure/fulcrum/SKILL.md
