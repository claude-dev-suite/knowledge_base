# Infrastructure - Specter Desktop - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/infrastructure/specter-desktop`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/infrastructure/specter-desktop/SKILL.md

## What this covers

Specter Desktop: open-source GUI for Bitcoin Core + multisig coordination + HW wallet. Designed for self-custody power users.
