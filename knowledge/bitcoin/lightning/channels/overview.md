...
> Canonical content lives in the dev-suite skill: **`bitcoin/lightning/channels`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/lightning/channels/SKILL.md
