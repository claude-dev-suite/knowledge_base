# Lightning - Keysend - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/lightning/keysend`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/lightning/keysend/SKILL.md

## What this covers

Keysend / spontaneous payments: send Lightning to a destination without an invoice. Receiver derives preimage from sender-supplied TLV record. BOLT 9 bit 50.
