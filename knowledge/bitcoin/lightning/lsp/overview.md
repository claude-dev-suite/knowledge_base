# Lightning - Lsp - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/lightning/lsp`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/lightning/lsp/SKILL.md
