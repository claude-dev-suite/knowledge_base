# Lightning - Routing - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/lightning/routing`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/lightning/routing/SKILL.md

## What this covers

Lightning pathfinding and routing: cost models, MPP / AMP / trampoline, blinded paths (BOLT 4 update), apriori probability, pickhardt-payments.
