# Lightning - Lnd - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/lightning/lnd`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/lightning/lnd/SKILL.md

## What this covers

LND (Lightning Network Daemon) by Lightning Labs: gRPC + REST API, macaroons, lncli, autopilot, channel backups (SCB), Tor support, watchtowers, integration with bitcoind/btcd/Neutrino backend.
