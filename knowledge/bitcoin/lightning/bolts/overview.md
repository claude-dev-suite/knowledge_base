# Lightning - Bolts - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/lightning/bolts`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/lightning/bolts/SKILL.md

## What this covers

BOLT (Basis of Lightning Technology) specification index. Wire format, channel management, onion routing, gossip, invoices, feature bits. Quick refs: BOLT-by-BOLT summary, message-type tables, feature-bit registry.
