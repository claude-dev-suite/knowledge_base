# Metaprotocols - Inscriptions - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/metaprotocols/inscriptions`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/metaprotocols/inscriptions/SKILL.md

## What this covers

Inscriptions: arbitrary data committed to specific sats via Taproot envelope structure. Foundation for BRC-20, recursive inscriptions, "Bitcoin NFTs".
