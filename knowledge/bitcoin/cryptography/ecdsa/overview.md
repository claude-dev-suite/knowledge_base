# Cryptography - Ecdsa - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/cryptography/ecdsa`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/cryptography/ecdsa/SKILL.md

## What this covers

ECDSA signatures over secp256k1: sign/verify, deterministic-k (RFC6979), low-s (BIP146), DER encoding, malleability, recoverable signatures.
