# Hardware - Krux - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/hardware/krux`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/hardware/krux/SKILL.md

## What this covers

Krux: DIY airgap signer running on Sipeed M5StickV / Maix Amigo. Open-source, multi-language, stateless.
