# Hardware - Psbt Flows - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/hardware/psbt-flows`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/hardware/psbt-flows/SKILL.md

## What this covers

PSBT signing flow patterns across HW vendors: USB direct, microSD airgap, QR airgap, NFC, multi-device coordination, silent-payment PSBT fields (BIP375/BIP376).
