# Hardware - Keystone - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/hardware/keystone`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/hardware/keystone/SKILL.md
