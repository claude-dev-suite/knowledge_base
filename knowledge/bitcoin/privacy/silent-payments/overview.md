# Privacy - Silent Payments - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/privacy/silent-payments`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/privacy/silent-payments/SKILL.md

## What this covers

Silent Payments (BIP352): single static address from which sender derives unique output per payment. Schnorr-based blinding; no notification tx needed.
