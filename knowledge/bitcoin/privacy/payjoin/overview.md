# Privacy - Payjoin - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/privacy/payjoin`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/privacy/payjoin/SKILL.md

## What this covers

PayJoin (BIP78 + v2): receiver-augmented payment that breaks common-input-ownership heuristic. v2 adds async relay support.
