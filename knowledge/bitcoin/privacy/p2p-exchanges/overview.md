# Privacy - P2P Exchanges - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/privacy/p2p-exchanges`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/privacy/p2p-exchanges/SKILL.md

## What this covers

P2P KYC-free Bitcoin exchanges: Bisq (desktop, Tor), RoboSats (Tor / browser, Lightning), Hodl Hodl (web, multisig escrow).
