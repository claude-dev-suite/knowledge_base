# Privacy - Tor - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/privacy/tor`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/privacy/tor/SKILL.md

## What this covers

Bitcoin over Tor: Tor v3 hidden services, onion-only nodes, bitcoind torcontrol integration, Lightning over Tor.
