# Privacy - Stealth - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/privacy/stealth`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/privacy/stealth/SKILL.md

## What this covers

Stealth addresses: ECDH-based derivation generating a unique output per payment. Pre-BIP47 / BIP352, conceptually similar.
