# L2 - Bsquared - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/l2/bsquared`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/l2/bsquared/SKILL.md

## What this covers

B² Network (BSquared): hybrid ZK + optimistic Bitcoin L2 with EVM compatibility. Live since 2024.
