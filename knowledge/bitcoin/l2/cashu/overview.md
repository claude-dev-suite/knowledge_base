...
> Canonical content lives in the dev-suite skill: **`bitcoin/l2/cashu`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/l2/cashu/SKILL.md

## What this covers

Cashu: single-mint Chaumian e-cash for Bitcoin Lightning. NUTs (Notation, Usage, and Terminology specs) define mint protocol, payment flow, blind signatures.
