...
> Canonical content lives in the dev-suite skill: **`bitcoin/l2/bitvm`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/l2/bitvm/SKILL.md

## What this covers

BitVM, BitVM2, BitVM3: off-chain computation framework using optimistic challenge games on Bitcoin script. Foundation for trust-minimized bridges to L2s and PoS chains.
