...
> Canonical content lives in the dev-suite skill: **`bitcoin/l2/stacks`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/l2/stacks/SKILL.md

## What this covers

Stacks: Bitcoin smart contract layer with Clarity language, sBTC for native peg, Nakamoto upgrade for fast finality, PoX (Proof of Transfer) consensus.
