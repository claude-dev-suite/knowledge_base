# L2 - Threshold Tbtc - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/l2/threshold-tbtc`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/l2/threshold-tbtc/SKILL.md

## What this covers

Threshold Network (tBTC): federated BTC bridge to Ethereum/EVM chains with t-of-n threshold signers, random group selection.
