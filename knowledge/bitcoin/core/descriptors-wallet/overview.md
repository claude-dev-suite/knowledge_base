# Core - Descriptors Wallet - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/core/descriptors-wallet`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/core/descriptors-wallet/SKILL.md

## What this covers

Bitcoin Core descriptors wallet: createwallet, importdescriptors, multipath, ranges, watch-only, signing wallets, multisig coordination. Replaces legacy BDB wallet.
