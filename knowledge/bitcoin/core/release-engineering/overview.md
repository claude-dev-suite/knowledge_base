# Core - Release Engineering - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/core/release-engineering`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/core/release-engineering/SKILL.md

## What this covers

Bitcoin Core release engineering: Guix reproducible builds, signed release tarballs, deterministic outputs, code-signing keys, the release process, security disclosure.
