...
> Canonical content lives in the dev-suite skill: **`bitcoin/core/operations`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/core/operations/SKILL.md

## What this covers

Running Bitcoin Core in production: bitcoin.conf reference, sections, pruning, signet, dbcache, mempool tuning, network bind, Tor, IBD considerations, debug.log analysis.
