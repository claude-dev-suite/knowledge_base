# Libraries - Mempool Js - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/mempool-js`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/mempool-js/SKILL.md

## What this covers

mempool.js (@mempool/mempool.js): TypeScript client for mempool.space API. REST + WebSocket; address history, fee estimates, mining stats.
