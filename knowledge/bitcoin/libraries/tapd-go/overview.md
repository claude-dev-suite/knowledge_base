# Libraries - Tapd Go - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/tapd-go`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/tapd-go/SKILL.md

## What this covers

taproot-assets daemon (tapd): Go implementation of Taproot Assets Protocol by Lightning Labs. Companion to LND.
