# Libraries - Nbitcoin - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/nbitcoin`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/nbitcoin/SKILL.md

## What this covers

NBitcoin: comprehensive .NET / C# Bitcoin library. Used by BTCPay Server, NBXplorer, many .NET tools. Tx, Script, PSBT, BIP32, HW wallet integration.
