# Libraries - Ldk - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/ldk`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/ldk/SKILL.md
