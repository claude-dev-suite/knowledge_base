# Libraries - Btcd - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/btcd`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/btcd/SKILL.md

## What this covers

btcd: full-node Bitcoin implementation in Go by btcsuite. Server, RPC, wallet (btcwallet), Lightning (LND-derived).
