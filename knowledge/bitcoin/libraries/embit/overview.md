# Libraries - Embit - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/embit`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/embit/SKILL.md

## What this covers

embit: Python Bitcoin library designed for embedded / hardware wallets (MicroPython compatible). Used by Specter DIY, Krux, SeedSigner.
