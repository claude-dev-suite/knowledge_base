# Libraries - Miniscript Rs - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/miniscript-rs`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/miniscript-rs/SKILL.md

## What this covers

rust-miniscript: Rust crate for Miniscript and descriptor handling. Policy compilation, satisfaction analysis, descriptor parsing for legacy + Tapscript.
