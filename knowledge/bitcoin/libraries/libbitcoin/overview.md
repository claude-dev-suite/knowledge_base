# Libraries - Libbitcoin - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/libbitcoin`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/libbitcoin/SKILL.md

## What this covers

libbitcoin: comprehensive C++ Bitcoin library. Multiple toolkits (libbitcoin-system, libbitcoin-server, libbitcoin-explorer). Alternative implementation focused on cleanliness.
