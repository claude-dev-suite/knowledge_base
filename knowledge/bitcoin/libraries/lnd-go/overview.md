# Libraries - Lnd Go - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/lnd-go`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/lnd-go/SKILL.md

## What this covers

lnd Go libraries: lnrpc (gRPC client), chantools (channel utilities), loopd (Loop client), poold (Pool client), neutrino (BIP157/158 SPV).
