# Libraries - Bdk Python - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/bdk-python`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/bdk-python/SKILL.md

## What this covers

bdkpython: Python bindings to BDK. Same descriptor-first wallet API as Rust BDK. UniFFI-generated.
