# Libraries - Bdk Jvm - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/bdk-jvm`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/bdk-jvm/SKILL.md

## What this covers

bdk-jvm / bdk-android: Kotlin/Java bindings to BDK. Same descriptor- first wallet API. UniFFI-generated.
