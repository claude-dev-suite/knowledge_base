# Libraries - Bitcoinj - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/libraries/bitcoinj`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/libraries/bitcoinj/SKILL.md

## What this covers

bitcoinj: mature Java/Kotlin Bitcoin library. SPV node, wallet, HD derivation, used by BlueWallet (Android), older mobile wallets.
