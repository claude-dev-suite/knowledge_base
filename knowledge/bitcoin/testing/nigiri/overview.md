# Testing - Nigiri - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/testing/nigiri`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/testing/nigiri/SKILL.md

## What this covers

Nigiri: regtest stack with Bitcoin + Esplora + electrs + Liquid + optional LN. CLI-based, fast iteration, includes faucet.
