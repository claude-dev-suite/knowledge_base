# Wallets - Vaults - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/wallets/vaults`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/wallets/vaults/SKILL.md

## What this covers

Bitcoin vault patterns: timelocked cooldown, hot/cold path with CSV, multisig vaults with quorum reduction over time, OP_VAULT proposal (BIP345), Revault architecture.
