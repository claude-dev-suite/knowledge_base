# Mining - Stratum V1 - Overview

> Canonical content lives in the dev-suite skill: **`bitcoin/mining/stratum-v1`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/mining/stratum-v1/SKILL.md

## What this covers

Stratum V1: TCP/JSON protocol between mining pool and miners. Subscribe, authorize, mining.notify, mining.submit. Most-used protocol but security/decentralization weaknesses.
