...
> Canonical content lives in the dev-suite skill: **`bitcoin/mining/difficulty`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/mining/difficulty/SKILL.md

## What this covers

Difficulty adjustment algorithm: 2016-block re-target window, max 4x factor, time-warp considerations, real-world hashrate dynamics.
