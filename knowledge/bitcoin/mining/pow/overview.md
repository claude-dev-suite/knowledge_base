...
> Canonical content lives in the dev-suite skill: **`bitcoin/mining/pow`**
> Source link: https://github.com/claude-dev-suite/claude-dev-suite/blob/main/skills/bitcoin/mining/pow/SKILL.md

## What this covers

Bitcoin Proof of Work: SHA256d on block header, target, nonce iteration, hashrate, mining math.
